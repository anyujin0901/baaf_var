...
def save_checkpoint(model, optimizer, scheduler, eachbatch, checkpoint_path):
    checkpoint = {
...
def load_checkpoint(model, optimizer, scheduler, checkpoint_path, train, device):
    ...
    if train:
        ...
        eachbatch = checkpoint['eachbatch']
        return model, optimizer, scheduler, eachbatch
    else:
        return model
