...
def args_parser():
    ...
    # The snr2 values to consider for SNR_fb = 20dB.
    # 23.53 (-1.0), 23.27 (-0.5),  23.01 (0)
    # 22.77 (0.5),  22.54 (1), 22.32 (1.5) 22.12 (2)
    parser.add_argument('--snr2', type=float, default= 100., help="Feedback SNR")
    parser.add_argument('--conf_th', type=float, default= 0.85, help="confidence threshold")
    parser.add_argument('--temperature', type=float, default=1.0, help="Temperature for the softmax in H_map receiver.")
    ...
    # parser.add_argument('--totalbatch', type=int, default=8, help="number of total batches to train")
    ...
    parser.add_argument('--embed_normalize', type=bool, default = False, help="normalize embedding")
    parser.add_argument('--belief_modulate', type=bool, default = False, help="modulate belief [-1,1]")
